                ...
                <div className="mt-12 px-4">
                    <div className="editor mx-auto flex w-10/12 max-w-2xl flex-col p-6 text-gray-800 shadow-lg mb-12 rounded-lg border-t-4 border-purple-400">
                        ...
                        <div className="mb-4">
                            ...
                            <label
                                for="file"
                                className="relative bg-gray-200 flex min-h-[200px] items-center justify-center rounded-md border border-dashed border-[#e0e0e0] p-12 text-center"
                            >
                                <div>
                        ...
                        <div className="buttons flex">
                            <hr className="mt-4" />
                            <div className="btn ml-auto rounded-md cursor-pointer  p-2 px-5 font-semibold text-gray-500">Hủy</div>
                            <div className="btn ml-2 rounded-md cursor-pointer bg-indigo-500 p-2 px-5 font-semibold text-gray-200">Thêm</div>
                        </div>
