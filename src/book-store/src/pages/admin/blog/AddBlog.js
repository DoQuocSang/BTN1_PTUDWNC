                ...
                <div className="mt-12 px-4">
                    <div className="editor mx-auto flex w-10/12 max-w-2xl flex-col p-6 text-gray-800 shadow-lg mb-12 rounded-lg border-t-4 border-purple-400">
                        ...
                        <div className="buttons flex">
                            ...
                            <Link to="/admin/dashboard/all-blog" className="btn ml-2 rounded-md transition duration-300 ease-in-out cursor-pointer hover:bg-indigo-700 bg-indigo-500 p-2 px-5 font-semibold text-white">
                                Thêm
                            </Link>
                        </div>
