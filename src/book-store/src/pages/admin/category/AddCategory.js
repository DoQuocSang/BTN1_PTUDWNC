                    ...
                    <div className="editor mx-auto flex w-10/12 max-w-2xl flex-col p-6 text-gray-800 shadow-lg mb-12 rounded-lg border-t-4 border-purple-400">
                        <div className="flex mb-4 items-center space-x-5">
                            ...
                            <div className="block pl-2 font-semibold text-xl self-start text-gray-700">
                                <h2 className="leading-relaxed">Thêm loại sách</h2>
                        ...
                        <div className="buttons flex">
                            <hr className="mt-4" />
                            <Link to="/admin/dashboard/all-category" className="btn ml-auto rounded-md transition duration-300 ease-in-out cursor-pointer hover:bg-gray-500 p-2 px-5 font-semibold hover:text-white text-gray-500">
                                Hủy
                            </Link>
                            <Link to="/admin/dashboard/all-category" className="btn ml-2 rounded-md transition duration-300 ease-in-out cursor-pointer hover:bg-indigo-700 bg-indigo-500 p-2 px-5 font-semibold text-white">
                                Thêm
                            </Link>
                        </div>
